...
class starter {
	public static void main(String args[]) throws FileNotFoundException {
		...
		*/
		while(true){
			...
			System.out.println("How mant words would u like printed");
			int ohio = sc.nextInt();
			//String skib = sc.nextline();
			printsNumber(arr,ohio);
		}
		    else if (choice.equals("change")){
	        System.out.println("what would you like to change the file to?");
	...
	*/
    ...
    for (int i = 0; i<arr.length; i++){
		...
		return com;	// Dummy value, delete when needed.
	}
