...
class starter {
    ...
    for (i = 0; i < board.length-3; i++){
    	for (ii = 0; ii < board[0].length; ii++){
    	if(board[i][ii].equals(board[i+1][ii]) && board[i+1][ii].equals(board[i+2][ii])board[i+2][ii].equals(board[i+3][ii]{
    		return 1;
    	}
    }
		return 0;
  ...
  for (i = 0; board.length < i; i++){
    	for (ii = 0; board[0].length; ii++){
    	if(board[i][ii].equals(board[i][ii+1])&&board[i][ii+2] ==board[i][ii+3] ){
    		return 1;
		return 0;
	}
